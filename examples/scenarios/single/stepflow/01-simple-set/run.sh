#!/bin/bash
# ============================================================================
# 01-simple-set: Minimal workflow with a single set step
# ============================================================================
...
WORKFLOW_NAME=$(random_name "starter-simple-set")
...
if ! $CLI wf create "$WORKFLOW_NAME" --dsl "$DSL_FILE" --description "Starter: 01-simple-set"; then
...
RUN_OUTPUT=$($CLI wf run "$WORKFLOW_NAME" --data '{"input": "test"}' 2>&1)
...
echo ""
success "01-simple-set completed successfully"
