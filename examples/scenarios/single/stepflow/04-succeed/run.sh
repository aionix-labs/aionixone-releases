#!/bin/bash
# ============================================================================
# 04-succeed: Explicit success termination
# ============================================================================
...
WORKFLOW_NAME=$(random_name "starter-succeed")
...
if ! $CLI wf create "$WORKFLOW_NAME" --dsl "$DSL_FILE" --description "Starter: 04-succeed"; then
...
echo ""
success "04-succeed completed successfully"
