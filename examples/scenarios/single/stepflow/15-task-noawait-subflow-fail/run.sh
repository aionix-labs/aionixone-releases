#!/bin/bash
# ============================================================================
# 15-task-noawait-subflow-fail: Fire-and-forget child workflow failure
# ============================================================================
...
header "Stepflow: 15-task-noawait-subflow-fail"
...
CHILD_WORKFLOW=$(random_name "starter-child-fail-ff")
...
PARENT_DSL="$(mktemp "${TMPDIR:-/tmp}/stepflow-noawait-15-XXXX.json")"
...
if ! $CLI wf create "$CHILD_WORKFLOW" --dsl "$CHILD_DSL" --description "Starter: 15-task-noawait-subflow-fail child"; then
...
if ! $CLI wf create "$PARENT_WORKFLOW" --dsl "$PARENT_DSL" --description "Starter: 15-task-noawait-subflow-fail parent"; then
...
echo ""
success "15-task-noawait-subflow-fail completed successfully"
