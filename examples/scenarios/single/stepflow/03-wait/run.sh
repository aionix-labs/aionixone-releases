#!/bin/bash
# ============================================================================
# 03-wait: Workflow with a wait step (delay execution)
# ============================================================================
...
WORKFLOW_NAME=$(random_name "starter-wait")
...
if ! $CLI wf create "$WORKFLOW_NAME" --dsl "$DSL_FILE" --description "Starter: 03-wait"; then
...
# Step 3: Wait for completion (longer timeout for wait step)
info "Waiting for completion (includes 2s delay)..."
timeout=30
WAITED=0
...
echo ""
success "03-wait completed successfully"
