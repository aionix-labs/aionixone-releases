#!/bin/bash
# ============================================================================
# 07-parallel: Concurrent branch execution
# ============================================================================
...
WORKFLOW_NAME=$(random_name "starter-parallel")
...
if ! $CLI wf create "$WORKFLOW_NAME" --dsl "$DSL_FILE" --description "Starter: 07-parallel"; then
    fail "Failed to create workflow"
fi
success "Workflow created"

# Step 2: Run workflow
info "Running workflow with 2 parallel branches..."
...
echo ""
success "07-parallel completed successfully"
